...
from ..environments import BaseEnv, MultiChoiceEnv
...
def get_task(
    ...
    if task_name == "hcp":
        from ..tasks.hcp import get_hcp as get_task_func

    elif task_name == "mid":
        from ..tasks.mid import get_mid as get_task_func

    elif task_name == "two-step":
        from ..tasks.two_step import get_two_step as get_task_func

    elif task_name == "risk-sensitive":
        from ..tasks.risk_sensitive import get_risk_sensitive as get_task_func

    elif task_name == "posner":
        from ..tasks.posner import get_posner as get_task_func

    elif task_name == "gonogo":
        from ..tasks.gonogo import get_gonogo as get_task_func
